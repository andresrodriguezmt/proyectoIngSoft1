...
class RepositorioEmpleadoTest {
    ...
    void testCrearEmpleado(){
        ...
        assertThat(empleado1.getIdEmpleado()).isGreaterThan(0);
    }
    ...
    void testListarEmpledos(){
        ...
        assertThat(listaEmpleados.isEmpty()).isFalse();
    }
    ...
    void testListarEmpleadosConDatos(){
        ...
        assertThat(listasEmpleados.isEmpty()).isFalse();
        assertThat(listasEmpleados.size()).isGreaterThan(0);
    }
