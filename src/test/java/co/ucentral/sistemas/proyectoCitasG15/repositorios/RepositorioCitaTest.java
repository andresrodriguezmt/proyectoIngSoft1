...
class RepositorioCitaTest {
    ...
    void testCrearCita(){
        ...
        assertThat(cita1.getIdCita()).isGreaterThan(0);
    }
    ...
    void testListarCitas(){
        ...
        assertThat(listaCitas.isEmpty()).isTrue();
    }
    ...
    void testListarCitasConDatos(){
        ...
        assertThat(listaCitas.isEmpty()).isFalse();
        assertThat(listaCitas.size()).isGreaterThan(1);
    }
